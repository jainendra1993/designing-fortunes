...
import '../view/component/notification_card.dart';
...
Future<void> firebaseMessagingForgroundHandler(ProviderContainer container) async {
  FirebaseMessaging.onMessage.listen((message) {
    ...
    container.read(notificationProvider.notifier).getNotification(
      itemPerPage: 15,
      pageNumber: 1,
    );
  });
