...
import 'package:ready_lms/features/auth/view/widget/onboarding_widget.dart';
...
class _AuthHomeScreenScreenState extends ConsumerState<AuthHomeScreen> {
  bool isClickedNextButton = false;
  @override
  void initState() {
    // _scrollAnimation();
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    //final isFirstOpen = ref.watch(hiveStorageProvider).getFirstOpenValue();
   ...
   /* if (isFirstOpen) {
    ...
    // Otherwise, show the original auth home screen
   /* return Scaffold(
