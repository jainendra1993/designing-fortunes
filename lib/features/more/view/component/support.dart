      ...
      child: Column(
        ...
        children: [
          ...
          Consumer(builder: (context, ref, _) {
            final bool subscription = ref.read(othersController.notifier).masterModel!.publishPlan ?? false;
            return (ref.read(hiveStorageProvider).isGuest() || subscription == false)
                ? SizedBox.shrink()
                : Text(
          ...
          Consumer(builder: (context, ref, _) {
            ...
            return (ref.read(hiveStorageProvider).isGuest() || subscription == false)
                ...
                : SupportButtonCard(
                    ...
                    icon: 'assets/images/crown_alt.png');
          }),
          16.ph,
          Consumer(builder: (context, ref, _) {
          ...
          Consumer(builder: (context, ref, _) {
            ...
            return (ref.read(hiveStorageProvider).isGuest() || subscription == false)
                ? SizedBox.shrink()
                : SupportButtonCard(
                    title: S.of(context).planAndPayment,
                    onTap: () {
                      context.nav.pushNamed(Routes.planExtendScreen);
                    },
                    icon: 'assets/images/plan_payment.png');
          }),
          16.ph,
          Consumer(builder: (context, ref, _) {
            return ref.read(hiveStorageProvider).isGuest()
                ...
                : SupportButtonCard(
                    ...
                    onTap: () {
                      context.nav.pushNamed(Routes.paymentHistoryScreen);
                    },
          ...
          /*  Consumer(builder: (context, ref, _) {
            return ref.read(hiveStorageProvider).isGuest()
                ? SizedBox.shrink() : SupportButtonCard(
                title: S.of(context).paymentHistory,
                onTap: () {
                  context.nav.pushNamed(Routes.paymentHistoryScreen);
                },
