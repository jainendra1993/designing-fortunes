...
import 'package:ready_lms/features/auth/controller/auth.dart';
...
import '../../../auth/view/widget/recover_pass_bottom_widget.dart';
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: AnimatedPadding(
        ...
        /// ✅ Prevents white / transparent background
        child: Material(
